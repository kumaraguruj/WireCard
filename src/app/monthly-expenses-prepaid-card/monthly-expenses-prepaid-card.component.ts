...
@Component({
  selector: 'app-monthly-expenses-prepaid-card',
  templateUrl: './monthly-expenses-prepaid-card.component.html',
  styleUrls: ['./monthly-expenses-prepaid-card.component.css']
})
export class MonthlyExpensesPrepaidCardComponent implements OnInit {
